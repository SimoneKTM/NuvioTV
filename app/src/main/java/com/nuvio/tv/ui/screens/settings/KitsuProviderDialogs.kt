...
private fun KitsuConnectContent(
    ...
    OutlinedTextField(
        ...
        modifier = Modifier
            ...
            .onPreviewKeyEvent { event ->
                ...
                if (
                    ...
                    isKitsuTokenSelectKey(native.keyCode)
                ) {
                    editing = true
        ...
        label = { Text(stringResource(R.string.kitsu_token_label)) },
    ...
    SettingsDialogActionRow(horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        SettingsDialogActionButton(
            text = stringResource(R.string.kitsu_open_authorize),
        ...
        SettingsDialogActionButton(
            text = stringResource(R.string.kitsu_connect),
            onClick = {
                editing = false
                keyboardController?.hide()
                onConnect(token)
...
private fun isKitsuTokenSelectKey(keyCode: Int): Boolean =
