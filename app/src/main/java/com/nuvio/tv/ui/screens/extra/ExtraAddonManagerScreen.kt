...
fun ExtraAddonManagerScreen(
    ...
    val defaultRefreshSubtitle = stringResource(R.string.extra_settings_update_subtitle)
    val refreshedAddonsSubtitle = stringResource(R.string.addon_refresh_done_subtitle)
    val refreshFailedSubtitle = stringResource(R.string.extra_settings_refresh_failed)
        ...
        LazyColumn(
                ...
                item(key = "install") {
                    Card(
                        ...
                        Column(modifier = Modifier.padding(20.dp)) {
                            Text(
                                text = stringResource(R.string.extra_add_addon),
            ...
            item(key = "update") {
                SettingsGroupCard(modifier = Modifier.fillMaxWidth()) {
                    SettingsActionRow(
                        title = stringResource(R.string.extra_settings_refresh_title),
                        subtitle = if (uiState.isRefreshing) {
                            stringResource(R.string.extra_settings_refreshing)
                        } else {
                            refreshSubtitle
                        },
                        onClick = {
            ...
            if (!isReadOnly) {
                item(key = "reorder") {
                    SettingsGroupCard(modifier = Modifier.fillMaxWidth()) {
                        SettingsActionRow(
                            title = stringResource(R.string.extra_settings_reorder_title),
                            subtitle = stringResource(R.string.extra_settings_reorder_subtitle),
            ...
            if (!isReadOnly) {
                item(key = "manage") {
                    SettingsGroupCard(modifier = Modifier.fillMaxWidth()) {
                        SettingsActionRow(
                            title = stringResource(R.string.extra_settings_manage_phone_title),
                            subtitle = stringResource(R.string.extra_settings_manage_phone_subtitle),
            ...
            item(key = "installed") {
                Row(
                    ...
                    Text(
                        text = stringResource(R.string.extra_addons_section),
            ...
            if (uiState.addons.isEmpty() && !uiState.isLoading) {
                item(key = "installed_empty") {
                    Text(
                        text = stringResource(R.string.extra_addons_empty),
...
@OptIn(ExperimentalTvMaterial3Api::class)
@Composable
internal fun ExtraAddonSettingsCard(
    addon: Addon,
    canMoveUp: Boolean,
    canMoveDown: Boolean,
    onMoveUp: () -> Unit,
