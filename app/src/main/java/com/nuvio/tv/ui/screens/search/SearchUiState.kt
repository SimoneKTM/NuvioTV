...
data class SearchUiState(
    ...
    val discoverMovieResults: List<MetaPreview> = emptyList(),
    val discoverSeriesResults: List<MetaPreview> = emptyList(),
    val discoverAnimeResults: List<MetaPreview> = emptyList(),
