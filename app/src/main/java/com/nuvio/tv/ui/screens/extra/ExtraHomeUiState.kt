...
sealed class ExtraHomeEvent {
    data class OnLoadMoreCatalog(val catalogId: String, val addonId: String, val type: String) : ExtraHomeEvent()
    data object OnRetry : ExtraHomeEvent()
}
