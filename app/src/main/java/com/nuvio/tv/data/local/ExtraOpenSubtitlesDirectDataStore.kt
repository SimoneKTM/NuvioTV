...
private val Context.extraOpenSubtitlesDataStore: DataStore<Preferences> by preferencesDataStore(
    name = "extra_opensubtitles_settings"
)

@Singleton
class ExtraOpenSubtitlesDirectDataStore @Inject constructor(
    @param:ApplicationContext private val context: Context
) {
    private val dataStore = context.extraOpenSubtitlesDataStore
    ...
    data class ExtraOpenSubtitlesDirectSettings(
    ...
    val settings: Flow<ExtraOpenSubtitlesDirectSettings> = dataStore.data.map { prefs ->
        val apiKey = prefs[apiKeyKey].orEmpty().trim()
        ExtraOpenSubtitlesDirectSettings(
