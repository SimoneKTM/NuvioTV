...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "INTRODB_API_KEY", "\"${localProperties.getProperty("INTRODB_API_KEY", "")}\"")
        ...
        buildConfigField("String", "ANILIST_CLIENT_ID", buildConfigString(resolveProperty(devProperties, localProperties, "ANILIST_CLIENT_ID")))
        buildConfigField("String", "ANILIST_REDIRECT_URI", buildConfigString(resolveProperty(devProperties, localProperties, "ANILIST_REDIRECT_URI", "urn:ietf:wg:oauth:2.0:oob")))
        buildConfigField("String", "KITSU_CLIENT_ID", buildConfigString(resolveProperty(devProperties, localProperties, "KITSU_CLIENT_ID")))
        buildConfigField("String", "KITSU_REDIRECT_URI", buildConfigString(resolveProperty(devProperties, localProperties, "KITSU_REDIRECT_URI", "nuvio://auth/kitsu")))
        buildConfigField("String", "KITSU_CLIENT_SECRET", buildConfigString(resolveProperty(devProperties, localProperties, "KITSU_CLIENT_SECRET")))
        buildConfigField("String", "MAL_CLIENT_ID", buildConfigString(resolveProperty(devProperties, localProperties, "MAL_CLIENT_ID")))
        ...
        buildConfigField("String", "GITHUB_OWNER", "\"SimoneKTM\"")
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "INTRODB_API_KEY", "\"${devProperties.getProperty("INTRODB_API_KEY", localProperties.getProperty("INTRODB_API_KEY", ""))}\"")
